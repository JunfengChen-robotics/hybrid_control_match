...
(cl:defmethod cl:initialize-instance :after ((m <PointArray>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'PointArray)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name mbot_explore-msg:<PointArray> is deprecated: use mbot_explore-msg:PointArray instead.")))

(cl:ensure-generic-function 'points-val :lambda-list '(m))
(cl:defmethod points-val ((m <PointArray>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader mbot_explore-msg:points-val is deprecated.  Use mbot_explore-msg:points instead.")
  (points m))
